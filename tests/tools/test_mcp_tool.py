...
from zero.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from zero.agent.tools.registry import ToolRegistry
from zero.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("zero.agent.tools.mcp.logger.warning", _warning)
