...
from zero.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
    ...
    def _validate_allow_from(self) -> None:
        for name, ch in self.channels.items():
            if getattr(ch.config, "allow_from", None) == []:
                # Allow Telegram to use its chat_id instead of allow_from
                if name == "telegram" and getattr(ch.config, "chat_id", None):
                    continue
                raise SystemExit(
