...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install zero-ai[matrix]"
    ) from e
...
from zero.config.paths import get_data_dir, get_media_dir
from zero.config.schema import Base
from zero.utils.helpers import safe_filename
