...
from zero.providers.base import LLMProvider, LLMResponse, ToolCallRequest
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/zero",
    "X-OpenRouter-Title": "zero",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply Zero attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
    ...
    async def chat_stream(
        ...
        idle_timeout_s = int(os.environ.get("ZERO_STREAM_IDLE_TIMEOUT_S", "90"))
        try:
