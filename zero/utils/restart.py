...
RESTART_NOTIFY_CHANNEL_ENV = "ZERO_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "ZERO_RESTART_NOTIFY_CHAT_ID"
RESTART_STARTED_AT_ENV = "ZERO_RESTART_STARTED_AT"
